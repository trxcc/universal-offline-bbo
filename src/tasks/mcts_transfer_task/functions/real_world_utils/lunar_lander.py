...
"""Experimenter function implementations for BBOB functions.
    ...
    [2] Li YL, Rudner TG, Wilson AG. A study of Bayesian neural network surrogates
        for Bayesian optimization. In ICLR 2024.
        https://arxiv.org/pdf/2305.20028.
        Code reference: https://github.com/yucenli/bnn-bo/blob/main/test_functions/lunar_lander.py

    [3] Song L, Gao C, Xue K, Wu C, Li D, Hao J, Zhang Z, Qian C. Reinforced 
        In-Context Black-Box Optimization. arXiv:2402.17423. 
        https://arxiv.org/pdf/2402.17423
        Code reference: https://github.com/songlei00/RIBBO/blob/master/problems/real_world_utils/lunar_lander.py
"""
