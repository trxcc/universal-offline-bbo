...
ax.set_title('t-SNE plot of UniSO-T embeddings',fontsize=25)
...
plt.savefig('task_embeddings_tsne_train_omnilatent.png')
plt.savefig('task_embeddings_tsne_train_omnilatent.pdf')
plt.close()